export const theme = {
  ...
  "transition": {
    "all": {
      ...
      "variable": "var(--transition-all)",
      "raw": "all .1s ease-in-out"
    }
  }
} as const
