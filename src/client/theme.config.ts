...
export default defineTheme({
  ...
  color: {
    $schema: {
      ...
      tags: ["@tokenType colors", "@icon material-symbols:palette"],
    },
    white: "#ffffff",
    black: "#0E0D0D",
    primary: {
  ...
  shadow: {
    $schema: {
      ...
      tags: ["@tokenType shadow", "@icon mdi:box-shadow"],
    },
  ...
  radii: {
    $schema: {
      ...
      tags: ["@tokenType size", "@icon material-symbols:rounded-corner"],
    },
    none: "0px",
    "3xs": "2px",
    "2xs": "4px",
  ...
  size: {
    $schema: {
      ...
      tags: ["@tokenType size", "@icon ph:ruler"],
    },
    "0": "0px",
    "2": "2px",
    "4": "4px",
  ...
  opacity: {
    $schema: {
      ...
      tags: ["@tokenType opacity", "@icon material-symbols:opacity"],
    },
    noOpacity: "0",
    bright: "0.1",
    light: "0.15",
  ...
  font: {
    $schema: {
      ...
      tags: ["@tokenType font", "@icon material-symbols:font-download-rounded"],
    },
  ...
  fontWeight: {
    $schema: {
      ...
      tags: ["@tokenType font-weight", "@icon radix-icons:font-style"],
    },
    thin: "100",
    extralight: "200",
    light: "300",
  ...
  fontSize: {
    $schema: {
      ...
      tags: ["@tokenType font-size", "@icon radix-icons:font-style"],
    },
    xs: "0.75rem",
    sm: "0.875rem",
    base: "1rem",
  ...
  lead: {
    $schema: {
      ...
      tags: ["@tokenType size", "@icon icon-park-outline:auto-line-height"],
    },
    1: ".025rem",
    2: ".5rem",
    3: ".75rem",
  ...
  text: {
    $schema: {
      ...
      tags: ["@tokenType size", "@icon material-symbols:format-size-rounded"],
    },
    1: {
